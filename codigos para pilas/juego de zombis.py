...
def iniciar_juego():
    ...
    #rectangulo = pilas.fisica.Rectangulo(48.0,-53.0,170,30, dinamica=False)     
    #rectangulo = pilas.fisica.Rectangulo(-18.1,7.0,38,100, dinamica=False) 
...
# Añadir la torreta del jugador
    ...
    def mover_boton(evento):
        pilas.boton.x = torreta.x
        pilas.boton.y=torreta.y
    pilas.eventos.actualizar.conectar(mover_boton)
